...
export default function Home() {
  ...
  const testimonials = [
    ...
    },
    {
      id: 3,
      name: "Coming Soon",
      excerpt: "More client testimonials will be added as they share their transformational experiences.",
      full: "",
      rating: 5,
      type: "placeholder"
    }
